    ...
    <div class="container my-5 py-5">
      ...
      <div class="section-header d-md-flex justify-content-between align-items-center">
        ...
        <div class="mb-4 mb-md-0">
          ...
          <p class="m-0">
    <a href="/allcats" class="filter-button me-4 filter-link active">ALL</a>
    <a href="/allcats?race=Persan" class="filter-button me-4 filter-link">Persan</a>
    <a href="/allcats?race=Siamois" class="filter-button me-4 filter-link">Siamois</a>
    <a href="/allcats?race=Bengal" class="filter-button me-4 filter-link">Bengal</a>
</p>
...
<div class="isotope-container row">
    <% 
    // Supposons que "catsList" est la liste des chats que vous avez enregistrés dans votre contrôleur
