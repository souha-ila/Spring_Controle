                ...
                <form  action="/admin/editblog/${blog.id}" method="post">
                  ...
                  <div class="form-group">
                    <label for="blogTitle">Title</label>
                     <input type="text" class="form-control" id="title" name="title" value="${blog.titre}" required>
                  </div>
                  <div class="form-group">
                 ...
                 <textarea class="form-control" id="Content" name="content" rows="4" required>${blog.content}</textarea>
                    ...
                    <label for="blogContent">Image</label>
                     ...
                     <input type="text" class="form-control" id="img" name="img" value="${blog.img}" required>
                  </div>
