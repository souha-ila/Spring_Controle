  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <h5 class="card-category">Add Blog</h5>
              </div>
              <div class="card-body">
                <!-- Your Blog Form Here -->
                <form action="addblog" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="img" name="img"  required></textarea>
                  </div>
        ...
        <div class="card-header">
            <h5 class="card-category">Blog List</h5>
        </div>
        <div class="card-body">
            <!-- Your Blog List Here -->
            <table class="table">
               ...
               <tbody>
                            ...
                            for (Blog blog : blogs) { %>
                                <tr>
                                    <th scope="row"><%= blog.getId() %></th>
                                    <td><%= blog.getTitre() %></td>
                                    <td><%= blog.getContent() %></td>
                                    <td><%= blog.getDate_publication() %></td>
                                    <td>
                <img src="<%= request.getContextPath() %>/resources/images/<%= blog.getImg() %>" alt="Blog Image" width="50" height="50">

                                    </td>
                                    <td> 
                          <a href="editblog/<%= blog.getId() %>">
              <img src="${pageContext.request.contextPath}/resources/images/edit.gif" alt="logo"  width="30" height="30" class="img-fluid">
                          </a>
                        <a href="deleteblog/<%= blog.getId() %>" onclick="return confirmDelete();">
