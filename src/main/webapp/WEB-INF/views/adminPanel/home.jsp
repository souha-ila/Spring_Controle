...
<body class=" ">
  <div class="wrapper ">
   ...
   <div class="content">
    ...
    <p>Welcome to CatZoom Dashboard! Here's a quick guide to help you get started:</p>

    <h4>1. Explore the Menu</h4>
    <p>On the left sidebar, you'll find a menu with different sections:</p>
    <ul>
        <li>Dashboard</li>
        <li>Cats: Information about various cat breeds.</li>
        <li>Products: Manage and showcase products.</li>
        <li>Blogs: Share and manage thoughts and experiences.</li>
        <li>User Profile: Manage profile settings.</li>
        <li>Messages: Manage messages of users.</li>
