      ...
      <div class="content">
          <div class="col-12">
            <div class="card card-chart">
              ...
              <div class="card-body">
                <!-- Your Blog Form Here -->
                <form action="your_blog_addition_servlet_or_endpoint" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="img" name="img" rows="4" required></textarea>
                  </div>
        ...
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td>Sample Blog Title 1</td>
                        <td>Sample Blog Content 1</td>
                        <td>2022-01-01</td>
                        <td>
                    ...
                    <tr>
                        <td>2</td>
                        <td>Sample Blog Title 2</td>
                        <td>Sample Blog Content 2</td>
                        <td>2022-01-02</td>
                        <td>
                            <button class="btn btn-warning btn-sm">Edit</button>
                            <button class="btn btn-danger btn-sm">Delete</button>
