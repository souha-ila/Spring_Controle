    ...
    <div class="col-12">
      <div class="card card-chart">
        <div class="card-header ">
          ...
          <div class="card-body">
            <!-- Your Product Form Here -->
            <form action="your_product_addition_servlet_or_endpoint" method="post">
              <!-- Add your product form fields here, e.g., name, description, price, img, etc. -->
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Sample Product Description 1</td>
                <td>$19.99</td>
                <td>product1.jpg</td>
                <td>
              ...
              <tr>
                ...
                <td>Sample Product Description 2</td>
                <td>$29.99</td>
                <td>product2.jpg</td>
                <td>
                  <button class="btn btn-warning btn-sm">Edit</button>
