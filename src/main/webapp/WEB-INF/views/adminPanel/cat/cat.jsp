  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
            ...
            <div class="card card-chart">
              ...
              <div class="card-body">
                ...
                <form action="addcat" method="post">
                  ...
                  <div class="form-group">
                    <label for="blogContent">Race</label>
        ...
        <div class="card-header">
            <h5 class="card-category">Cat List</h5>
        </div>
        <div class="card-body">
            ...
            <table class="table">
               ...
               <tbody>
                            ...
                            for (Chat chat : chats) { %>
                                <tr>
                                    <th scope="row"><%= chat.getId() %></th>
                                    <td><%= chat.getNom() %></td>
                                    <td><%= chat.getRace() %></td>
                                <td><%= chat.getDescription() %></td>
                                    <td>
                <img src="<%= request.getContextPath() %>/resources/images/<%= chat.getImage() %>" alt="Blog Image" width="50" height="50">

                                    </td>
                                    <td> 
                          <a href="editcat/<%= chat.getId() %>">
              <img src="${pageContext.request.contextPath}/resources/images/edit.gif" alt="logo"  width="30" height="30" class="img-fluid">
                          </a>
                        <a href="deletecat/<%= chat.getId() %>" onclick="return confirmDelete();">
